...
# Cinder Client Release Notes documentation build configuration file,
# created by sphinx-quickstart on Tue Nov  4 17:02:44 2015.
#
...
htmlhelp_basename = 'CinderClientReleaseNotesdoc'
